...
\newcommand{\red}[1]{\colortext{BrickRed}{#1}}
...
\newcommand{\sgnp}[1]{{\sign \left( #1 \right) }}
\usepackage{amsfonts}  % Used for \mathbb and \mathcal
\usepackage{amssymb}
\usepackage{bbm}       % Used for \mathbbm
\usepackage{mathrsfs}  % Used for \mathscr
\usepackage{relsize}   % Used for \mathsmaller and \mathlarger
\usepackage{optidef}   % Used for mini! constrained optimization
